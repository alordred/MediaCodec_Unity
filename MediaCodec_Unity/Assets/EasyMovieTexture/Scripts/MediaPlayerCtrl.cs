...
public class MediaPlayerCtrl : MonoBehaviour
{
	...
	void Update()
	{
		...
		{			
			...
			CheckThreading ();
            Debug.Log("checkNewActions");
		}

		if (m_bFirst == false)
		{
            Debug.Log("(m_bFirst == false");
	...
	Call_Load(strName,0);
        ...
        //Debug.Log("m_CurrentState == Out");
        m_CurrentState = MEDIAPLAYER_STATE.PLAYING;//AL
	...
	Call_SetUnityTexture (m_VideoTexture.GetNativeTextureID ());
            ...
            //Debug.Log("Call_UpdateVideoTexture Unity");
    ...
    private void Call_SetDirection(long direction)
    {
    Debug.Log("EasyMovieTextureCsharp,Call");
